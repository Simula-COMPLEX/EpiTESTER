...
PATH = '/home/complexse/workspace/Chengjie/EpiTESTER'
    ...
    def _load_and_run_scenario(self, args, config, solution):
        ...
        try:
            ...
            if not self.sensors:
                ...
                self.statistics_manager.save_sensors(self.sensor_icons, '{}{}'.format(args.checkpoint_path, self.checkpoint_file))
        ...
        self.objective, self.min_dis = self.manager.run_scenario()
