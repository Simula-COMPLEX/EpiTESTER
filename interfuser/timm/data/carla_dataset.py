...
class CarlaMVDetDataset(BaseIODataset):
    ...
    def __getitem__(self, idx):
        ...
        '''
        You can use tools/example_data/batch_merge_data.py to generate FULL image (including front, left, right) for reducing io cost
        ...
        '''
        You can use tools/example_data/batch_merge_data.py to generate FULL measurements for reducing io cost
