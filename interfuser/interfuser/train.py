...
parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="load lidar example_data in the dataset",
)
parser.add_argument(
    "--with-seg",
    action="store_true",
    default=False,
    help="load segmentation example_data in the dataset",
)
parser.add_argument(
    "--with-depth",
    action="store_true",
    default=False,
    help="load depth example_data in the dataset",
)
parser.add_argument(
    "--multi-view",
    action="store_true",
    default=False,
    help="load multi-view example_data in the dataset",
)
parser.add_argument(
...
def main():
    ...
    # create example_data loaders w/ augmentation pipeiine
