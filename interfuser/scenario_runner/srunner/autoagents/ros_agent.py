...
class RosAgent(AutonomousAgent):
    ...
    The sensor example_data is published on similar topics as with the carla-ros-bridge. You can find details about
    ...
    def publish_lidar(self, sensor_id, data):
        """
        Function to publish lidar example_data
        """
        ...
        # we need a copy here, because the example_data are read only in carla numpy
        # array
    ...
    def publish_gnss(self, sensor_id, data):
        """
        Function to publish gnss example_data
        """
        msg = NavSatFix()
    ...
    def publish_camera(self, sensor_id, data):
        """
        Function to publish camera example_data
        """
        msg = self.cv_bridge.cv2_to_imgmsg(data, encoding='bgra8')
        # the camera example_data is in respect to the camera's own frame
        msg.header = self.get_header()
    ...
    def run_step(self, input_data, timestamp):
        ...
        # publish example_data of all sensors
