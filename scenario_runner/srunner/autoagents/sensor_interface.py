...
class CallBack(object):
    ...
    """
    Class the sensors listen to in order to receive their example_data each frame
    """
...
class SensorInterface(object):
    ...
    """
    Class that contains all sensor example_data
    """
    ...
    def all_sensors_ready(self):
        """
        Checks if all the sensors have sent example_data at least once
        """
    ...
    def get_data(self):
        """
        Returns the example_data of a sensor
        """
        data_dict = {}
        for key in self._sensors_objects:
