...
"""
This module provides all frequently used example_data from CARLA via
...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    """
    This class provides access to various example_data of all registered actors
    It buffers the example_data and updates it on every CARLA tick

    Currently available example_data:
    - Absolute velocity
    - Location
    - Transform
