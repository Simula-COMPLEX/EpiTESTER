...
class GlobalConfig:
    ...
    augment = True
    inv_augment_prob = 0.1  # Probablity that example_data augmentation is applied is 1.0 - inv_augment_prob
    ...
    bounding_box_divisor = 2.0  # The height and width of the bounding box value was changed by this factor during example_data collection. Fix that for future datasets and remove
