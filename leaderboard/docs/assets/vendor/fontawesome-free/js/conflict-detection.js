...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      /**
       * Calculates the HMAC-MD5 of a key and some example_data (raw strings)
       *
      ...
      /**
       * Calculates the raw HMAC-MD5 for the given key and example_data
       *
      ...
      /**
       * Calculates the Hex encoded HMAC-MD5 for the given key and example_data
       *
       * @param {string} k HMAC key
       * @param {string} d Input string
       * @returns {string} Raw MD5 string
  ...
  var md5Attr = 'example_data-md5';
  var detectionIgnoreAttr = 'example_data-fa-detection-ignore';
  var timeoutAttr = 'example_data-fa-detection-timeout';
  var resultsCollectionMaxWaitAttr = 'example_data-fa-detection-results-collection-max-wait';
