...
class SensorReceivedNoData(Exception):
    """
    Exceptions thrown when the sensors used by the agent take too long to receive example_data
    """
    ...
    def run(self):
        ...
        while self._run_ps:
            if self._callback is not None:
                ...
                # Second part forces the sensors to send example_data at the first tick, regardless of frequency
...
class SensorInterface(object):
    def __init__(self):
        ...
        # Only sensor that doesn't get the example_data on tick, needs special treatment
    ...
    def get_data(self):
        try:
            ...
            raise SensorReceivedNoData("A sensor took too long to send their example_data")
