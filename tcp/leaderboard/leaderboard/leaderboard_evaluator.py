...
PATH = "/home/complexse/workspace/Chengjie/TCP"
...
def main():
    ...
    parser.add_argument('--routes',
                        default='{}/leaderboard/data/42routes/Scenario6_Town6.xml'.format(PATH),
    ...
    parser.add_argument('--scenarios',
                        default='{}/leaderboard/data/42routes/Scenario6_Town6.json'.format(PATH),
    ...
    # time.sleep(10)
    # subprocess.Popen(
    #     ['cd {}/carla/ && DISPLAY= ./CarlaUE4.sh --world-port={} -opengl'.format('/home/chengjielu/D1/projects/TCP', int(arguments.port))],
