    ...
    def run_scenario(self, scenario_id):
        ...
        while self._running:
            ...
            if timestamp:
                ...
                dis_npc, dis_ped = self._tick_scenario(timestamp, scenario_id)
    ...
    def _tick_scenario(self, timestamp, scenario_id):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            try:
                ...
                ego_action, tag = agent_out[0], agent_out[1]
            ...
            spectator.set_transform(carla.Transform(ego_trans.location +
                                                    carla.Location(x=-10*ego_trans.rotation.get_forward_vector().x,
                                                                   y=-10*ego_trans.rotation.get_forward_vector().y,
                                                                   z=4),
                                                    ego_trans.rotation))
